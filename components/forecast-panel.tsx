...
export default function ForecastPanel({ forecastData }: ForecastPanelProps) {
  ...
  forecastData.forEach((forecast, index) => {
    ...
    const dateDisplay = `${getDayOfWeek(date)}, ${date.toLocaleDateString("en-US", {
      month: "short",
      day: "numeric",
    })}`
      ...
      >
        <CardContent className="p-2.5">
          <div className="flex justify-between items-center mb-1">
            ...
            <div className="font-semibold text-blue-600 text-lg">{forecast.actual_wave_height_ft} ft</div>
          </div>

          <div className="grid grid-cols-2 gap-x-2 gap-y-1 text-sm">
            <div className="flex items-center justify-between">
              <span className="text-gray-500">Period:</span>
              <span className="font-medium text-teal-600">{forecast.wave_period_s} s</span>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center">
                <ArrowUp
                  ...
                  style={{ transform: `rotate(${forecast.swell_direction_deg}deg)` }}
                />
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center">
                <ArrowUp
                  className="h-3.5 w-3.5 mr-1 transform text-blue-600"
                  style={{ transform: `rotate(${compassToDegrees(forecast.wind_direction)}deg)` }}
                />
          ...
          <div className="text-xs text-gray-400 mt-1">Measured: {forecast.wave_height_ft} ft</div>
        </CardContent>
      </Card>,
    )
  })
